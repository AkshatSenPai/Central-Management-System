    ...
    <div className="space-y-6 p-4 sm:p-8">
      ...
      {rows.length === 0 ? (
        ...
        <div className="overflow-x-auto rounded-lg border border-[var(--border)] bg-[var(--surface)]">
          {/* overflow-x-auto above, not overflow-hidden: the five-column row
              keeps a min-width for legibility, so on a phone the list pans
              sideways rather than crushing every column. */}
          <div
